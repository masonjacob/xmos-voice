...
#****************************
## set(MODEL_LANGUAGE "custom_model")
## set(MODEL_BUILD_VERSION "dev")
## set(SENSORY_WAKEWORD_SEARCH_HEADER_FILE "${CMAKE_CURRENT_LIST_DIR}/model/${MODEL_LANGUAGE}/wakeword-pc60w-7.0.0-op10-${MODEL_BUILD_VERSION}-search.h")
## set(SENSORY_WAKEWORD_SEARCH_SOURCE_FILE "${CMAKE_CURRENT_LIST_DIR}/model/${MODEL_LANGUAGE}/wakeword-pc60w-7.0.0-op10-${MODEL_BUILD_VERSION}-search.c")
## set(SENSORY_WAKEWORD_NET_SOURCE_FILE "${CMAKE_CURRENT_LIST_DIR}/model/${MODEL_LANGUAGE}/wakeword-pc60w-7.0.0-op10-${MODEL_BUILD_VERSION}-net.c")

## set(SENSORY_COMMAND_SEARCH_HEADER_FILE "${CMAKE_CURRENT_LIST_DIR}/model/${MODEL_LANGUAGE}/command-pc62w-6.4.0-op10-${MODEL_BUILD_VERSION}-search.h")
## set(SENSORY_COMMAND_SEARCH_SOURCE_FILE "${CMAKE_CURRENT_LIST_DIR}/model/${MODEL_LANGUAGE}/command-pc62w-6.4.0-op10-${MODEL_BUILD_VERSION}-search.c")
## set(SENSORY_COMMAND_NET_FILE "${CMAKE_CURRENT_LIST_DIR}/model/${MODEL_LANGUAGE}/command-pc62w-6.4.0-op10-${MODEL_BUILD_VERSION}-net.bin.nibble_swapped")

set(SENSORY_WAKEWORD_SEARCH_HEADER_FILE "${CMAKE_CURRENT_LIST_DIR}/model/wakeword-pc60w-7.0.0-op10-dev-search.h")
set(SENSORY_WAKEWORD_SEARCH_SOURCE_FILE "${CMAKE_CURRENT_LIST_DIR}/model/wakeword-pc60w-7.0.0-op10-dev-search.c")
set(SENSORY_WAKEWORD_NET_SOURCE_FILE "${CMAKE_CURRENT_LIST_DIR}/model/wakeword-pc60w-7.0.0-op10-dev-net.c")

set(SENSORY_COMMAND_SEARCH_HEADER_FILE "${CMAKE_CURRENT_LIST_DIR}/model/command-pc62w-6.4.0-op10-dev-search.h")
set(SENSORY_COMMAND_SEARCH_SOURCE_FILE "${CMAKE_CURRENT_LIST_DIR}/model/command-pc62w-6.4.0-op10-dev-search.c")
set(SENSORY_COMMAND_NET_FILE "${CMAKE_CURRENT_LIST_DIR}/model/command-pc62w-6.4.0-op10-dev-net.bin.nibble_swapped")
...
# Tile Targets
#**********************
set(TARGET_NAME tile0_example_low_power_ffd_sensory)
...
set(TARGET_NAME tile1_example_low_power_ffd_sensory)
add_executable(${TARGET_NAME} EXCLUDE_FROM_ALL)
target_sources(${TARGET_NAME} PUBLIC ${APP_SOURCES})
target_include_directories(${TARGET_NAME} PUBLIC ${APP_INCLUDES} ${RTOS_CONF_INCLUDES})
...
# Merge binaries
#**********************
merge_binaries(example_low_power_ffd_sensory tile0_example_low_power_ffd_sensory tile1_example_low_power_ffd_sensory 1)

#**********************
# Create run and debug targets
#**********************
create_run_target(example_low_power_ffd_sensory)
create_debug_target(example_low_power_ffd_sensory)

#**********************
# Create data partition support targets
#**********************
set(TARGET_NAME example_low_power_ffd_sensory)
